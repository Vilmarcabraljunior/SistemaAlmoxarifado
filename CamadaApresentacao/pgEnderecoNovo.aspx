<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageInterna.master" AutoEventWireup="true" CodeBehind="pgEnderecoNovo.aspx.cs" Inherits="CamadaApresentacao.pgEnderecoNovo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ConteudoInterno" runat="server">

    <!--Panel com as opções de gravar ou buscar um endereço-->
    <asp:Panel ID="pnlPesquisar" runat="server">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-5">
                        <asp:LinkButton ID="lkbNovo" runat="server" CssClass="btn btn-success btn-sm" OnClick="lkbNovo_Click"><i class="fa fa-plus-circle"> Novo Endereço</i></asp:LinkButton>
                        <asp:LinkButton ID="lkbConsultar" runat="server" CssClass="btn btn-success btn-sm" data-toggle="modal" data-target="#BuscarEnderecoModal"><i class="fa fa-search"> Buscar Endereço</i></asp:LinkButton>
                    </div>
                </div>
            </div>
    ...
    <!--Script para reabrir modal Novo Endereço-->
    <script type="text/javascript">
        function openNovoEnderecoModal() {
            $('#NovoEnderecoModal').modal('show');
        }
    </script>
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <asp:Label ID="lblEnderecoNovoTitulo" runat="server" Text="Novo Endereço" CssClass="fa fa-plus-circle"></asp:Label></h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEnderecoDescricao" runat="server" CssClass="form-control input-sm" placeholder="Digite o Endereço" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="GridViewEnderecoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtBuscarPorCodigo" runat="server" CssClass="form-control input-sm" placeholder="Digite o código do endereço."></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtBuscarPorDescricao" runat="server" CssClass="form-control input-sm" placeholder="Digite o endereço." TextMode="MultiLine"></asp:TextBox>
                                        <span class="input-group-btn">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <h5><strong>Tem Certeza que Deseja Excluir este Endereço ?</strong></h5>
