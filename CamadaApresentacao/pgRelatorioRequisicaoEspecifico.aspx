<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pgRelatorioRequisicaoEspecifico.aspx.cs" Inherits="CamadaApresentacao.pgRelatorioRequisicaoEspecifico" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row well well-sm">
            <table style="width: 1300px;">
                <tr>
                    <td style="width: 300px;">
                        <div class="col-md-11">
                            <h3><strong>Guia de Remessa de Material</strong></h3>
                        </div>
                    </td>
                    <td style="width: 300px;">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="form-group">
                                <strong>
                                    <label for="lblCodigoRotulo" style="font-size: 18px">Requisição N.:</label></strong>
                                <p>
                    ...
                    <td style="width: 300px;">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="form-group">
                                <strong>
                                    <label for="lblDataCadastroRotulo" style="font-size: 18px">Atendida em:</label></strong>
                                <p>
        ...
        <div class="row">
            <table style="width: 600px;">
                <tr>
                    ...
                    <td style="width: 300px;">
                         <div class="col-md-10 col-md-offset-1" style="left: 180px";>
                            <strong>_____________________________________________________________</strong>
                        </div>
                    </td>
                </tr>
        ...
        <div class="row" >
            <table style="width: 600px;">
                <tr>
                    ...
                    <td style="width: 300px;">
                        <div class="col-md-10 col-md-offset-1" style="left: 490px";>
        ...
        <div class="row">
            <table style="width: 600px;">
                <tr>
                    <td style="width: 250px;">
                        <div class="col-md-10 col-md-offset-1" style="left: 350px";>
                            <strong>_____________________________________________________________</strong>
        ...
        <div class="row" >
            <table style="width: 600px;">
                <tr>
                    <td style="width: 300px";>
                        <div class="col-md-10 col-md-offset-1" style="left: 500px";>
                            <strong>Assinatura do Requisitante</strong>
                        </div>
                    </td>
                </tr>
            </table>
